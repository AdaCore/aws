...
# On GNAT 3.15 pragma Obsolescent and -gnatwj option is not supported, so we
# do not use this option and furtheremore we do not treat warnings as errors.
STYLE_FLAGS     = -gnatwcfimpruv -gnaty3abcefhiklmnoprst
endif
