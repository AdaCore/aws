...
package body AI302.Containers.Indefinite_Vectors is
   ...
   procedure Write
     (Stream    : access Root_Stream_Type'Class;
      ...
      N : constant Size_Type := Length (Container);

   begin

      Size_Type'Base'Write (Stream, N);
   ...
   procedure Set_Length
     (Container : in out Vector;
      ...
      N : constant Size_Type := Indefinite_Vectors.Length (Container);
   ...
   procedure Insert_Internal
     (Container : in out Vector;
      ...
      Last_As_Int : constant Int := Int (Container.Last);

      New_Last_As_Int : constant Int'Base := Last_As_Int + Count;
...
--           E (Index .. Index_Type'Pred (Container.Last)) :=
--             E (Index_Type'Succ (Index) .. Container.Last);

--           E (Container.Last) := null;
...
--     end Delete;
   ...
   begin
      ...
      for I in Index .. Index_Type'Pred (J) loop
   ...
   begin
      ...
      begin
         ...
         exception
            when others =>
               for J in Index_Type'First .. Index_Type'Pred (Elements'Last) loop
                  Free (Elements (J));
               end loop;
   ...
   begin
      ...
      elsif Before.Index in Index_Type'First .. Container.Last then
         Index := Before.Index;

      else
         Index := Index_Type'Succ (Container.Last);  --TODO: CE?
   ...
   begin
      ...
      if Is_Empty (Container) then  --TODO: correct semantics?
         return No_Element;
      end if;
