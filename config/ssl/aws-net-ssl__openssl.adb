...
package body AWS.Net.SSL is
   ...
   protected type TS_SSL is
      ...
      function Get_Check_Host return Boolean;
   ...
   begin
      ...
      if Socket.Config.Get_Check_Host then
   ...
   protected body TS_SSL is
      ...
      function Get_Check_Host return Boolean is
      begin
         return Check_Host;
      end Get_Check_Host;
