...
$CA_BATCH -in aws-server-2.csr -cert private-ca.crt -keyfile private-ca.key -out aws-server-2.crt
...
$CA_BATCH -in aws-client.csr -cert private-ca.crt -keyfile private-ca.key -out aws-client.crt
