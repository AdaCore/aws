...
with simple.doc.net.sd.radius_Type_Pkg;
...
procedure AttSimCont is
   ...
   use simple.doc.net.sd.radius_Type_Pkg;
   ...
   CNF      : Config.Object;
   P1       : constant n1_ExampleType_Type :=
                (1.3, To_Unbounded_String ("cm"));
   P2       : constant n1_radius_Type := From_float_Type (3.4);
   P3       : constant n1_Rec_Type := (P2, P1);
...
begin
   ...
   Text_IO.Put_Line ("P2:");
   Text_IO.Put_Line
     (SOAP.Types.XML_Image (To_SOAP_Object (P2, "ft"),
                            Encoding => SOAP.WSDL.Schema.Literal,
                            Schema   => AttSimContService.Schema));
   Text_IO.Put_Line ("P3:");
   Text_IO.Put_Line
     (SOAP.Types.XML_Image (To_SOAP_Object (P3, "data"),
                            Encoding => SOAP.WSDL.Schema.Literal,
                            Schema   => AttSimContService.Schema));

   AttSimContService.Client.Call (1.2, P3);
