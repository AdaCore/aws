...
procedure Back_Proc (Port : Positive; Security : Boolean) is
   ...
   Store_Socket     : Net.Socket_Type'Class := Net.Socket (Security);
   Store_Keep_Alive : Boolean;

   type String_Access is access constant String;

   HTTP_Token : aliased constant String := "http";
   HTTPS_Token : aliased constant String := "https";

   Prefix : constant array (Boolean) of String_Access
     := (False => HTTP_Token'Access, True => HTTPS_Token'Access);

   URL : constant String
     := Prefix (Security).all & "://localhost:" & Utils.Image (Port);
