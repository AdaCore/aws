...
with WSDL_1b;
with WSDL_1b_Service.Server;

package body WSDL_1b_Server is

   use Ada;
   use SOAP;

   function Print_CB is new WSDL_1b_Service.Server.Print_CB (WSDL_1b.Print);
   function Image_CB is new WSDL_1b_Service.Server.Image_CB (WSDL_1b.Image);
   function Print_Small_CB is
      new WSDL_1b_Service.Server.Print_Small_CB (WSDL_1b.Print_Small);
