...
package body SD2_Server_CB is
   ...
   procedure Call (x : Integer; y : Float);
   ...
   function SOAP_CB is
     new Simpledocservice2.Server.call_CB (Call);
   ...
   begin
      ...
      declare
         R : constant Response.Data :=
               SOAP_Wrapper (Request, Simpledocservice2.Schema);
      begin
   ...
   procedure Call (x : Integer; y : Float) is
   begin
      Text_IO.Put_Line (">>>>> " & Integer'Image (X) & Float'Image (Y));
   end Call;
