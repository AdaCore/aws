...
procedure AttSimCont is
   ...
   procedure Call (a : Float; b : n1_ExampleType_Type);
   ...
   procedure Call (a : Float; b : n1_ExampleType_Type) is
   begin
      Text_IO.Put_Line ("a : " & a'Image);
      Text_IO.Put_Line ("b : " & b'Image);
   end Call;

   H_Server : Server.HTTP;
   CNF      : Config.Object;
   P1       : constant n1_ExampleType_Type :=
                (To_Unbounded_String ("cm"), [], 2.9, 2, [9]);
...
begin
   ...
   Text_IO.Put_Line ("P1:");
   Text_IO.Put_Line
     (SOAP.Types.XML_Image (To_SOAP_Object (P1, "b"),
                            Encoding => SOAP.WSDL.Schema.Literal,
                            Schema   => AttSimContService.Schema));

   AttSimContService.Client.Call (1.2, P1);
