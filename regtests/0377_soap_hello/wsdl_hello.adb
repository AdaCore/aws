...
procedure WSDL_Hello is
   ...
   procedure WSDL_Demo_Client is
      ...
      R : Sayhello_Result;
   begin
      R := R_Hello_Demo.Client.sayHello
        (S1 => "AWS/SOAP",
         S2 => "One/Two",
         S3 => "Normalized/String");
   ...
   function sayHello
     (S1 : String;
      S2 : String;
      S3 : String) return Sayhello_Result;
   ...
   function sayHello
     (S1 : String;
      S2 : String;
      S3 : String) return Sayhello_Result is
   begin
      return
        (To_Unbounded_String ("S1: '" & S1 & "' "),
         To_Unbounded_String ("S2: '" & S2 & "' "),
         To_Unbounded_String ("S3: '" & S3 & "'"));
   end sayHello;
