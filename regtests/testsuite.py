...
class AWSTestsuite(Testsuite):
    ...
    def set_up(self):
        ...
        if self.env.options.root_dir:
            build_dir = self.env.options.root_dir[0] + os.sep + gcc_target.stdout.decode('UTF-8').rstrip()
        else:
            build_dir = ".." + os.sep + gcc_target.stdout.decode('UTF-8').rstrip()
        ...
        # AWS 'make setup'
        try:
            with open(build_dir + os.sep + "testsuite.tags") as tags_file:
        ...
        if self.env.options.from_build_dir:
            ...
            c = MakeVar(build_dir + os.sep + "makefile.setup")
