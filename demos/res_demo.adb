...
with rdemo; -- this package is generated by AWSRes
pragma Warnings (Off, rdemo);

procedure Res_Demo is
...
begin
   ...
   AWS.Server.Start (WS, "Res Demo",
                     Max_Connection => 1,
                     Callback       => RD_CB'Unrestricted_Access);
